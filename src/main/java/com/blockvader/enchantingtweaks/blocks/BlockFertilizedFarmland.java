...
public class BlockFertilizedFarmland extends Block{
	
	public static final PropertyInteger FERTILITY = PropertyInteger.create("fertility", 0, 15);
	...
	public BlockFertilizedFarmland()
	{
        ...
        this.setDefaultState(this.blockState.getBaseState().withProperty(FERTILITY, Integer.valueOf(15)));
	...
	{
	    int i = ((Integer)state.getValue(FERTILITY)).intValue();
	    if (i == 0)
	    {
	    ...
	    if (!this.hasWater(worldIn, pos) && !worldIn.isRainingAt(pos.up()))
	    {
	        if (i > 0)
	        {
	            worldIn.setBlockState(pos, state.withProperty(FERTILITY, Integer.valueOf(i - 1)), 2);
	        }
	    }
	    else if (worldIn.getBlockState(pos.up()).getBlock() instanceof BlockCrops)
	    {
	    	worldIn.getBlockState(pos.up()).getBlock().updateTick(worldIn, pos.up(), worldIn.getBlockState(pos.up()), rand);
    ...
    {
        return this.getDefaultState().withProperty(FERTILITY, Integer.valueOf(meta & 15));
    }
    ...
    {
        return ((Integer)state.getValue(FERTILITY)).intValue();
    }

    protected BlockStateContainer createBlockState()
    {
        return new BlockStateContainer(this, new IProperty[] {FERTILITY});
    }
    ...
    public boolean canSustainPlant(IBlockState state, IBlockAccess world, BlockPos pos, EnumFacing direction, IPlantable plantable)
    {
    	...
    	if (plantType == EnumPlantType.Crop || plantType == EnumPlantType.Plains) return true;
