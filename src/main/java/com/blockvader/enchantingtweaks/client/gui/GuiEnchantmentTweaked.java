...
public class GuiEnchantmentTweaked extends GuiContainer
{
    ...
    private final ContainerEnchantmentTweaked container;
    public int ticks;
    public float flip;
    public float oFlip;
    public float flipT;
    ...
    public GuiEnchantmentTweaked(InventoryPlayer inventory, World worldIn, IWorldNameable nameable)
    {
        super(new ContainerEnchantmentTweaked(inventory, worldIn));
        this.playerInventory = inventory;
        this.container = (ContainerEnchantmentTweaked)this.inventorySlots;
