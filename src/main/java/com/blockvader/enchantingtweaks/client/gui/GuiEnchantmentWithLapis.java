...
public class GuiEnchantmentWithLapis extends GuiContainer
{
	...
	private final ContainerEnchantmentWithLapis container;
	public int ticks;
	public float flip;
	public float oFlip;
	public float flipT;
	...
	public GuiEnchantmentWithLapis(InventoryPlayer inventory, World world, BlockPos pos, IWorldNameable nameable)
	{
		super(new ContainerEnchantmentWithLapis(inventory, world, pos));
		this.playerInventory = inventory;
		this.container = (ContainerEnchantmentWithLapis)this.inventorySlots;
