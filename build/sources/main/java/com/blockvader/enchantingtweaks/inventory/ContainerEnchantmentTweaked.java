...
public class ContainerEnchantmentTweaked extends ContainerEnchantment
{
	private World world;
	...
	public ContainerEnchantmentTweaked(InventoryPlayer playerInv, World worldIn) {
		this(playerInv, worldIn, BlockPos.ORIGIN);
	}

	public ContainerEnchantmentTweaked(InventoryPlayer playerInv, World worldIn, BlockPos pos) {
